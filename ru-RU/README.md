...
В первом случае, мы пытаемся вывести второй элемент в `['🍍']` подмассива `[['🍊', '🍌'], ['🍍']]`. Этот подмассив содержит только один элемент, что означает, что в индексе `1` нет элемента, поэтому возвращает значение `undefined`.
...
В конце, мы попытаемся вывести второй элемент в `['🍊', '🍌']` подмассива `['🍍'], ['🍊', '🍌']`. Элемент с индексом `1` в этом подмассиве — `🍌`, который и выводится на экран.
